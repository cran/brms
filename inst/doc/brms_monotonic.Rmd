...
```
For technical reasons, monotonic group-level effects have to be specified in separate terms in the model formula. Further, we have used the abbrevation `mono` for `monotonic`, which helps in shortening the formula. The summary output
