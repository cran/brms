...
posterior samples of all `m` submodels. While pooling across models is not
...
achieved by combining the posterior samples of the submodels. Accordingly, all
...
'one-step' approach, we have to explictly specify the variables used in the
