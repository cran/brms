...
data arises. **binomial** and **bernoulli** families are distinguished in
brms as the bernoulli distribution has its own implementation in Stan
that is computationlly more efficient.
